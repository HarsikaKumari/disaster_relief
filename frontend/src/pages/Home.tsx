        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20'>
          ...
          >
            <Link to='/register'>
              <Button
                size='lg'
                className='bg-white text-primary hover:bg-sand-light shadow-xl shadow-primary/30 hover:shadow-primary/40 text-base px-8 h-12 rounded-xl transition-all duration-300'
              >
                Get Started
            ...
            <Link to='/map'>
              <Button
                size='lg'
                variant='outline'
                className='border-white/30 text-white hover:bg-white/10 hover:border-white/50 text-base px-8 h-12 rounded-xl transition-all duration-300'
              >
          ...
          >
            ...
            <div className='mt-10 flex flex-col sm:flex-row gap-4 justify-center'>
              <Link to='/register'>
                <Button
                  size='lg'
                  className='bg-white text-primary hover:bg-sand-light shadow-xl shadow-black/20 hover:shadow-black/30 text-base px-8 h-12 rounded-xl transition-all duration-300'
                >
                  Register Now
                  <ArrowRight className='ml-2 w-5 h-5' />
                </Button>
