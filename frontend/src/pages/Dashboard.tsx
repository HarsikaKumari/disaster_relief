      ...
      <div className='flex items-start gap-3'>
        ...
        <div className='flex-1 min-w-0'>
          <div className='flex items-start justify-between gap-2'>
            ...
            <div
              className={`px-2 py-0.5 rounded-full text-[10px] font-medium border ${getStatusColor(emergency.status)} flex-shrink-0`}
            >
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        if (emergenciesRes.data.success) {
          ...
          const formattedEmergencies = emergenciesRes.data.data.map(
            (e: any) => ({
              id: e.id,
              title: e.title,
            ...
            <div className='relative flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
              <div>
                ...
                <p className='text-white/80 text-sm mt-0.5'>
                  ...
                  {stats.availableVolunteers} volunteers online
                </p>
              </div>
              <Link to='/Emergencies'>
                ...
                {loading ? (
                  ...
                  activities.map((item, index) => (
                    <ActivityItem
                      ...
                      color={
                        item.type === 'EMERGENCY' ? 'bg-accent' : 'bg-success'
                      }
                    />
                  ))
                ) : (
                ...
                {[
                  {
                    ...
                    status: stats.activeEmergencies > 0 ? 'Active' : 'Standby',
                    color:
                  ...
                  },
                  {
                    ...
                    status: stats.availableVolunteers.toString(),
                    color: 'text-success',
                  },
                  {
                    label: 'Resources Available',
                    status: stats.resourcesAvailable.toString(),
                    color: 'text-warning',
                  },
                  {
                    label: 'System Uptime',
              ...
              <div className='grid grid-cols-2 gap-2.5'>
                ...
                <div className='bg-gradient-to-br from-accent/15 to-accent/5 rounded-2xl p-3 text-center border border-accent/10'>
                  <p className='text-xl font-bold text-accent'>
                    {loading ? '...' : stats.activeEmergencies}
                  </p>
                ...
                <div className='bg-gradient-to-br from-primary/15 to-primary/5 rounded-2xl p-3 text-center border border-primary/10'>
                  <p className='text-xl font-bold text-primary'>
                    {loading ? '...' : stats.availableVolunteers}
                  </p>
